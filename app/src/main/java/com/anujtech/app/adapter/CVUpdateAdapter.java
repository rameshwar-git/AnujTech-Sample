...
public class CVUpdateAdapter extends RecyclerView.Adapter<CVUpdateAdapter.ViewHolder> {
    ...
    public CVUpdateAdapter(Context mcontext, ArrayList<String> mFileName, ArrayList<String> mFileUri, ArrayList<String> mContact1, ArrayList<String> mContact2, ArrayList<String> mDate, ArrayList<String> mTimestamp) {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        final CVUpdateAdapter mCVUpdateAdapter;
        ...
        public ViewHolder(@NonNull View itemView, CVUpdateAdapter mCVUpdateAdapter) {
            super(itemView);
            this.mCVUpdateAdapter = mCVUpdateAdapter;
        ...
        private void onClick(View view) {
            if (view.getId() == R.id.upload) {
                ...
                Toast.makeText(imageView.getContext(), "Uploading", Toast.LENGTH_SHORT).show();
                DatabaseReference upload = databaseReference.child("Interview").child("CV")
                        .child(mCVUpdateAdapter.mTimestamp.get(getAdapterPosition()));
                upload.updateChildren(update)
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                        Toast.makeText(imageView.getContext(), "Updated", Toast.LENGTH_SHORT).show();
                        Intent intent=new Intent(mCVUpdateAdapter.mcontext, CVUpdateAdapter.class);
                ...
                upload.removeValue()
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void unused) {
                                ...
                                StorageReference storageReference = storage.getReference().child("Images").child("Interview")
                                        .child(mCVUpdateAdapter.mFileName.get(getAdapterPosition()));
