...
import com.anujtech.app.adapter.ClintUpdateAdapter;
import com.anujtech.app.cache.CacheUtil;
...
public class UpdateClinteInterview extends AppCompatActivity {

    //Array
    private  ArrayList<String> mFileName = new ArrayList<>();
    private  ArrayList<String> mFileUri = new ArrayList<>();
    private  ArrayList<String> mContact1 = new ArrayList<>();
    private  ArrayList<String> mContact2 = new ArrayList<>();
    private  ArrayList<String> mDate = new ArrayList<>();
    private  ArrayList<String> mTimeStamp = new ArrayList<>();
    //firebase
    protected FirebaseDatabase mDatabase ;
    protected DatabaseReference databaseReference;
    private ClintUpdateAdapter mAdapter;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new ClintUpdateAdapter(this, mFileName, mFileUri, mContact1, mContact2, mDate, mTimeStamp);
    ...
    protected void onResume() {
        super.onResume();
        //database
        CacheUtil.clearExternalCache(this);
        CacheUtil.clearInternalCache(this);
        ...
        databaseReference.child("Interview")
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(UpdateClinteInterview.this, "Error", Toast.LENGTH_SHORT).show();
                    }
                });
